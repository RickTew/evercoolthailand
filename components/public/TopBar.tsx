...
import { RevealPhoneText, DialButton } from "./RevealPhone";
    ...
    <header className="sticky top-0 z-40 bg-ec-navy/95 backdrop-blur-sm text-white border-b border-white/5">
      <div className="mx-auto max-w-[480px] md:max-w-3xl lg:max-w-5xl flex items-center justify-between px-4 py-2">
        ...
        <div className="flex items-center gap-1">
          {/* Phone - visible on desktop, number revealed on click */}
          <div className="hidden md:flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm text-white/70 hover:text-white hover:bg-white/10 transition-colors mr-1">
            <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
            </svg>
            <RevealPhoneText revealLabel={t.callUs} />
          </div>
          ...
          {/* Phone icon - mobile only, number built on tap */}
          <DialButton

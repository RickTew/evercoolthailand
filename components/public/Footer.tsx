...
import { RevealPhoneText, RevealEmailText, WhatsAppButton } from "./RevealPhone";
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 mb-5">
              <div className="flex items-center gap-2 text-xs text-white/60">
                ...
                <RevealPhoneText className="hover:text-white transition-colors" revealLabel="Show phone number" />
              </div>
              <WhatsAppButton
              ...
              <div className="flex items-center gap-2 text-xs text-white/60">
                ...
                <RevealEmailText className="hover:text-white transition-colors" revealLabel="Show email address" />
              </div>
            </div>
